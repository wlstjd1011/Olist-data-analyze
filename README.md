...
- **같은 소요 일수에서도 지역에 따라 만족도가 다릅니다.** 22~30일 걸린 주문에서 빠른 주는 3.13,
  느린 주는 3.90입니다. 8~14일까지는 세 무리가 붙어 있다가 15일부터 벌어지므로,
  느린 주가 전반적으로 후한 것으로는 설명되지 않습니다.
...
- **제안은 소량 패딩과 실험입니다.** 위반은 6,378건(6.7%)뿐이고 나머지는 이미 안정적입니다.
  3일 패딩이면 1점 주문이 773건 줄어드는 것으로 계산되나, 관측 자료로는 약속을 옮겼을 때
  기대도 따라 옮겨지는지 확인할 수 없어 실험으로 검증해야 합니다.
